...
import static uk.gov.justice.subscription.jms.generator.ClassNameFactory.JMS_LISTENER;
 ...
 * message types described in the subscription.
 */
public class MessageListenerCodeGenerator {
    ...
    public TypeSpec generate(final SubscriptionWrapper subscriptionWrapper,
        ...
        return classSpecFrom(subscriptionWrapper, subscription, commonGeneratorProperties, classNameFactory, serviceComponentStrategy)
    ...
    private boolean shouldListenToAllMessages(final List<Event> events, final String component) {
