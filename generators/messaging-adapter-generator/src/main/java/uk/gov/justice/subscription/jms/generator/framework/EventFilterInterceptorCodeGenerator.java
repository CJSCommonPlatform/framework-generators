...
/**
 * Should generate a custom EventFilterInterceptor that uses a custom Event Filter. Something like
 * this:
 *
 * <pre>
 *  {@code
...
public class EventFilterInterceptorCodeGenerator {
    ...
    /**
     * Generate a custom EventFilterInterceptor which uses a custom {@see
     * uk.gov.justice.services.event.buffer.api.EventFilter}
     *
