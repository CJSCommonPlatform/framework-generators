...
public class MessageListenerCodeGeneratorTest {
    ...
    public void shouldGenerateMDBForTopic() {
        ...
        final EventServiceComponentStrategy componentStrategy = new EventServiceComponentStrategy(classNameFactory, subscription);

        final TypeSpec typeSpec = messageListenerCodeGenerator.generate(
                subscriptionWrapper,
                subscription,
                (CommonGeneratorProperties) generatorProperties,
                classNameFactory,
                componentStrategy);
    ...
    public void shouldGenerateMDBForCommandHandlerQueue() {
        ...
        final SubscriptionWrapper subscriptionWrapper = new SubscriptionWrapper(subscriptionsDescriptor, eventSourceDefinitions);
        final DefaultServiceComponentStrategy componentStrategy = new DefaultServiceComponentStrategy(classNameFactory, subscription);
